 ...
 * @author Jiri Hynek
 */
class BlueSkyLayerToolDefaults extends LayerToolDefaults implements IBlueSkyLayerToolDefaults {
    ...
    public getType(): string {
        return BlueSkyLayerToolDefaults.TYPE;
    }
...
export default BlueSkyLayerToolDefaults;